...
let lebakFoods : [TraditionalFoodModel] = [
    TraditionalFoodModel(name: "Leumung", images: ["leumeung"], fact: "Di Sumatera Barat juga ada, rasanya sama tapi bedanya pake kacang merah", ingredient: "Beras ketan dan bumbu santan kelapa", method: "Bikinnya dimasukin ke dalam bilah-bilah bambu terus dibakar pada perapian hingga matang.Makannya warga Banten biasanya pake telor asin sebagai pendamping. Disajiin lebih enak abis matang dalam keadaan hangat", origin: bantenCities[0]),
    TraditionalFoodModel(name: "Kue Jojorong", images: ["kue jojorong"], fact: "Dari tanah Pasundan", ingredient: "Tepung sanji, tepung beras, dan gula merah", method: "Penyajiannya, dibungkus daun pisang. Makannya, biasanya pake sendok langsung di daunnya.Bikinnya dikukus", origin: bantenCities[0]),
...
let pandeglangFoods : [TraditionalFoodModel] = [
    TraditionalFoodModel(name: "Kue Apem", images: ["kue apem"], fact: "Salah satu kuliner favorit sultan Banten yang biasanya tersaji pada acara khaul sultan.", ingredient: "tepung beras, gula merah, daun pandan, santan", method: "Bikinnya di kukus. Makannya bisa langsung, tp biasanya warga banten pake gula merah atau kinca. Kalo ga suka gula bisa ganti madu atau sirup.", origin: bantenCities[1]),
    TraditionalFoodModel(name: "Emping Melinjo", images: ["emping melinjo"], fact: "Biasa disebut juga kerupuk melinjo dan keceprek.", ingredient: "biji melinjo", method: "Bikinnya disangrai, digeprek dan dijemur melinjonya. habis itu digoreng.", origin: bantenCities[1]),
    TraditionalFoodModel(name: "Balok Menes", images: ["balok menes"], fact: "Diluar Banten, orang menyebutnya getuk, punya cita rasa serta aroma yang sangat khas.", ingredient: "singkong dan serundeng kelapa", method: "Bikinnya singkong ditumbuk, ditipiskan, dicetak. Bagian tengah di poles minyak bawang dan ditambah bawang goreng. Makannya bukan sama parutan kelapa, tapi serundeng.", origin: bantenCities[1])
]
...
let serangFoods : [TraditionalFoodModel] = [
    ...
    TraditionalFoodModel(name: "Rabeg", images: ["rabeg"], fact: "Hasil adaptasi dari kuliner Arab. Orang Serang yang keturunan Jawa menyebutnya dengan wedhus. Rasanya ada pedas bercampur manis. Secara sekilas mirip semur campur tongseng tapi didalamnya terdapat jahe, lada dan cabai merah.", ingredient: "daging, jeroan kambing, rempah-rempah", method: "Bikinnya di tumis hingga meresap.Penyajiannya harus hangat.", origin: bantenCities[2]),
    ...
    TraditionalFoodModel(name: "Nasi Sumsum", images: ["nasi sumsum"], fact: "Pertama kali hadir pada tahun 1941 oleh seorang tukang potong hewan yang bekerja di Serang yang membawa pulang sisa-sisa tulang untuk diolah jadi makanan. Di tangan istri, sumsum tulang tersebut dicampurkan ke dalam nasi.", ingredient: "sumsum tulang sapi, gula jawa, beras, daun pisang, batang lidi, rempah-rempah (cabai merah besar, kemiri, bawang putih, bawang merah)", method: "Bikinnya, bumbu ditumis dicampur dengan nasi, lalu dimasukkan ke daun pisang akhirnya dibakar. Penyajiannya baru dibakar saat mau dimakan.", origin: bantenCities[2]),
    TraditionalFoodModel(name: "Sambel Burog", images: ["sambel burog"], fact: "Biasanya sebagai oleh-oleh untuk para jemaah sepulang menghadiri pengajian.", ingredient: "kulit melinjo (kulit tangkil)", method: "Bikinnya, ditumis hingga harum. Makannya biasa bersama nasi.", origin: bantenCities[2]),
